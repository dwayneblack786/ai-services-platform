 ...
 */
router.post('/execute', authenticateSession, async (req: Request, res: Response) => {
    try {
 ...
 */
router.delete('/session/:sessionId', authenticateSession, async (req: Request, res: Response) => {
    try {
