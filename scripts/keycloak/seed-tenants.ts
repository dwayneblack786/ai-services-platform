 ...
 * 
 * Compatibility wrapper. Delegates to ai-product-management local script.
 * 
 * Usage:
 *   npx ts-node scripts/keycloak/seed-tenants.ts
 */

const targetScript = path.resolve(__dirname, '../../ai-product-management/scripts/keycloak/seed-tenants.ts');
